...
def generate_launch_description():
    ...
    default_params_file = os.path.join(get_package_share_directory("xe_tham_do"), 'config',
    ...
    log_param_change = LogInfo(
        msg=['provided params_file ', params_file, ' does not contain slam_toolbox parameters. Using default: ',
